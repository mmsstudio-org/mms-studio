            ...
            <div className="space-y-4">
                ...
                <Alert variant="default" className="bg-muted/30">
                    ...
                    <AlertDescription className="space-y-2">
                        ...
                        <p>If your verification exceeds 6 hours, please contact us via the <button onClick={() => setHelpOpen(true)} className="underline font-medium">Help Center</button> or WhatsApp (text only).</p>
                    </AlertDescription>
                </Alert>
            </div>
